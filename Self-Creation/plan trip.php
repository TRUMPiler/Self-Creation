    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                ...
                <h1 class="text-light"><a href="home.php"><span>Travel planner</span></a></h1>
        ...
        <div class="container">
            ...
            <form class="myForm">
                <div class="form-group">
                    ...
                    <input type="test" class="form-control"  id="address" name="source" placeholder="Enter from where you are going to travel">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="daddress" name="Destination" placeholder="Enter where do you wish to reach" onchange=overloading()>
                </div>
                <input type="text" name="dlat" id="" hidden>
                <input type="text" name="dlong" id="" hidden>
                <div class="form-group">
                    <label for="Email">From Date:</label>
                    <input type="datetime-local" class="form-control" name="From_date" placeholder="Enter your email">
                </div>
                <div class="form-group">
                    <label for="Password">To Date:</label>
                    <input type="datetime-local" class="form-control" name="To_date" placeholder="Enter password">
                </div>
...
<!-- 
                ...
                $("form").on("submit",function(event)
                {
                    ...
                    function(data,status)
                    {
                        if(data=="true")
                        {
                            alert("your travel plan has been sent to your registered email");
